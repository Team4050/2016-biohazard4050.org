...
function handleJSON() {
    ...
    console.log("There are Bios for " + descriptionArray.length + " people.");
    ...
    for(i = 0; i < descriptionArray.length; i++) {
        ...
        console.log("Name = " + name + ". Name without spaces = " + nameSanSpace);
        ...
        // var imageNode = document.createNode(Image);
